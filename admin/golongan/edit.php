...
if (!isset($_SESSION['nama'])) {
    ...
    $id = $_GET['id'];
    $query = $link->query("SELECT * FROM golongan WHERE id_golongan = '$id'");
...
<div class="container py-5 ">
                ...
                <div class="card mb-4">
                    <div class=" mt-n3 mx-3 z-index-2 ps-1">
                        <div class="bg-gradient-info shadow border-radius-lg pt-3 pb-3 ">
                            <h6 class="text-white text-center text-capitalize ">Edit Data Golongan</h6>
                        </div>
                    </div>
                                                        ...
                                                        <div class="input-group input-group-dynamic">
                                                            <div class="input-group input-group-dynamic mb-4">
                                                                <input class="form-control" aria-label="Nama golongan"
                                                                    ...
                                                                    value="<?= $data['nm_golongan'] ?>" required>
    ...
    <?php
    if (isset($_POST['edit'])) {
        $namagolongan = $_POST['nm_golongan'];


        $edit = $link->query("UPDATE golongan SET nm_golongan = '$namagolongan' WHERE id_golongan = '$id'");
        ...
        if ($edit) {
            ...
            echo "<meta http-equiv='refresh' content='0; url=?page=edit_golongan'>";
        }
    }
}
