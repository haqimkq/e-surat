...
?>
    ...
    <div class="container-fluid px-2 px-md-4">
        <div class="page-header min-height-300 border-radius-xl mt-4" style="background-image: url('https://i.ytimg.com/vi/bd4ENPsn8BI/maxresdefault.jpg');">
            ...
            <div class="row">
                        ...
                        <div class="col-lg-4 ms-sm-auto  mt-4">
                            <div class="nav-wrapper position-relative end-7">
                                <ul class="nav  nav-pills nav-fill p-2" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link mb-0 px-0 py-1 " data-bs-toggle="ta" href="javascript:;" role="ta" aria-selected="false">
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-group input-group-dynamic">
                                        ...
                                        <div class="input-group input-group-dynamic mb-4">
                                            <input class="form-control" type="text" readonly value="<?= $data['nm_pegawai'] ?>" />
                                ...
                                <div class="col-md-6">
                                    <div class="input-group input-group-dynamic">
                                        ...
                                        <div class="input-group input-group-dynamic mb-4">
                                            <input class="form-control" type="text" readonly value=" <?= $data['nip'] ?> " />
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="input-group input-group-dynamic">
                                        ...
                                        <div class="input-group input-group-dynamic mb-4">
                                            <input class="form-control" type="text" readonly value="<?= $data['nm_golongan'] ?> " />
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="input-group input-group-dynamic">
                                        ...
                                        <div class="input-group input-group-dynamic mb-4">
                                            <input class="form-control" type="text" readonly value=" <?= $data['nm_jabatan'] ?> " />
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="input-group input-group-dynamic">
                                        ...
                                        <div class="input-group input-group-dynamic mb-4">
                                            <input class="form-control" type="text" readonly value="<?= $data['tmpt_lahir'] ?> " />
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="input-group input-group-dynamic">
                                        ...
                                        <div class="input-group input-group-dynamic mb-4">
                                            <input class="form-control" type="text" readonly value="<?= $data['alamat'] ?> " />
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="input-group input-group-dynamic">
                                        ...
                                        <div class="input-group input-group-dynamic mb-4">
                                            <input class="form-control" type="text" readonly value="<?= $data['no_tlp'] ?> " />
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="input-group input-group-dynamic">
                                        ...
                                        <div class="input-group input-group-dynamic mb-4">
                                            <input class="form-control" type="text" readonly value="<?= $data['instagram'] ?> " />
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-md-4">
                    <div class="card card-profile">
                        <img src="https://i.pinimg.com/originals/6c/2d/fb/6c2dfbaad8570f79f7f3ee4ab13fe42a.jpg" alt="Image placeholder" class="card-img-top ">
                        <div class="row justify-content-center">
                            <div class="col-4 col-lg-4 order-lg-2">
                                <div class="mt-n4 mt-lg-n6 mb-4 mb-lg-0">
                                    <a href="javascript:;">
                                        <img src="<?php echo "../img/$data[foto]" ?>" class="rounded-circle img-fluid border border-2 border-white ">
                                    </a>
                                </div>
                            </div>
                        </div>
