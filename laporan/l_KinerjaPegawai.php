...
if (isset($_POST['cetak9'])) {
    ...
    $sql = mysqli_query($link, "SELECT * FROM skp k join pegawai p on k.id_pegawai = p.id_pegawai join jabatan j on k.id_jabatan = j.id_jabatan ORDER BY k.tgl_kinerja  ");
    $label = 'LAPORAN DATA PENILAIAN KINERJA PEGAWAI';
}
