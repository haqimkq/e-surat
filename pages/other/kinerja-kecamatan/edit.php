                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <input type="hidden" class="form-control" name="id_msy" id="id_msy"
                                                        required value="<?= $data['id_msy'] ?>">

                                                    <div class=" col-md-6">
                                                        <div class="input-group input-group-dynamic">
                                                            <label>No KTP</label>
                                                            <div class="input-group input-group-dynamic mb-4">
                                                                <input class="form-control" aria-label="No KTP"
                                                                    type="text" data-minlength="4"
                                                                    data-error="Tidak Boleh Kurang dari 4" required
                                                                    readonly value="<?= $data['no_ktp'] ?>">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input-group input-group-dynamic">
                                                            ...
                                                            <div class="input-group input-group-dynamic ">
                                                                <input class="form-control" aria-label="Nama Masyarakat"
