...
if (!isset($_SESSION['nama'])) {
    ...
    $skp = null;
    if (@$_GET['id']) {
        $skp = $link->query("SELECT * FROM skpKecamatan WHERE idSkpKec = '$_GET[id]'")->fetch_assoc();
    }
?>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class=" col-md-12">
                                                            <div class="input-group input-group-dynamic">
                                                                ...
                                                                <div class="input-group input-group-dynamic mb-4">
                                                                    <input class="form-control" aria-label="No KTP" type="text" data-minlength="4" data-error="Tidak Boleh Kurang dari 4" required readonly value="<?= $data['no_ktp'] ?>">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group input-group-dynamic">
                                                                ...
                                                                <div class="input-group input-group-dynamic ">
                                                                    <input class="form-control" aria-label="Nama Masyarakat" type="text" name="nama" data-minlength="4" data-error="Tidak Boleh Kurang dari 4" required readonly value="<?= $data['nama'] ?>">
                                                                    <div class="help-block with-errors"></div>
                                                                </div>
                                                            </div>
                                                        </div>
...
<?php
    if (isset($_POST['edit'])) {
        ...
        $edit = $link->query("UPDATE skpKecamatan SET 
id_msy = '$id_msy', 
...
WHERE idSkpKec = '$id'");
        ...
        if ($edit) {
            ...
            echo "<meta http-equiv='refresh' content='0; url=?page=editKinerjaKecamatan'>";
        }
    }
}
