                ...
                <table border="1" cellspacing="1" cellpadding="6" width="100%">
                    <thead style="background-color: #5F9EA0">
                        <tr>
                            ...
                            <th style="text-align: center; font-size: 18px; width:10%;">Surat Pengantar Dari KUA</th>
                        ...
                        $data = $query->fetch_array(); { ?>
                            <tr>
                                ...
                                <td class="w-10" align="center">
                                    <?php echo "<a href='../../../img/{$data['ktp_p']}' download><img src='../../../img/{$data['ktp_p']}' width='110' height='85' style='border-radius: 5%;' /></a>"; ?>

                                </td>
                                <td class="w-10" align="center">
                                    <?php echo "<a href='../../../img/{$data['kk_p']}' download><img src='../../../img/{$data['kk_p']}' width='110' height='85' style='border-radius: 5%;' /></a>"; ?>
