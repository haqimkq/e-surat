                                            ...
                                            <form data-toggle="validator" action="" method="POST" enctype="multipart/form-data">
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <h6> <i>Rekomendasi Dispensasi Nikah</i></h6>
                                                        <!-- <hr class="horizontal dark"> -->
                                                        <br>
                                                        <br>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group input-group-dynamic">
                                                                ...
                                                                <div class="input-group input-group-dynamic mb-4">
                                                                    <input class="form-control" aria-label="Foto" type="file" name="kk_p" data-minlength="4" data-error="Tidak Boleh Kurang dari 4" required>
                                                                    <div class="help-block with-errors"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group input-group-dynamic">
                                                                ...
                                                                <div class="input-group input-group-dynamic mb-4">
                                                                    <input class="form-control" aria-label="Foto " type="file" name="s_kua" data-minlength="4" data-error="Tidak Boleh Kurang dari 4" required>
                                                                    <div class="help-block with-errors"></div>
                                                                </div>
