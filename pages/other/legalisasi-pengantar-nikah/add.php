                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input-group input-group-dynamic">
                                                            ...
                                                            <div class="input-group input-group-dynamic mb-2">
                                                                <input class="form-control" aria-label="" type="file"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input-group input-group-dynamic">
                                                            ...
                                                            <div class="input-group input-group-dynamic mb-2">
                                                                <input class="form-control" aria-label="Foto"
                                                                    type="file" name="akte_c" data-minlength="4"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input-group input-group-dynamic">
                                                            ...
                                                            <div class="input-group input-group-dynamic mb-2">
                                                                <input class="form-control" aria-label="Foto "
                                                                    type="file" name="sk" data-minlength="4"
                                                                    data-error="Tidak Boleh Kurang dari 4">
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                            <em class="text-danger text-sm text-italic">*Upload
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input-group input-group-dynamic">
                                                            ...
                                                            <div class="input-group input-group-dynamic mb-2">
                                                                <input class="form-control" aria-label="Foto "
                                                                    type="file" name="skwn" data-minlength="4"
                                                                    data-error="Tidak Boleh Kurang dari 4" required>
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                            <em class="text-danger text-sm text-italic">*Upload
