                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-5 text-center me-7 mt-4">
                                                    ...
                                                    <div class="input-group input-group-dynamic m-5">
                                                        ...
                                                        <div class="input-group input-group-dynamic ">
                                                            <input class="form-control" aria-label="Foto Kartu Keluarga :" type="file" name="pas_foto" data-minlength="4" data-error="Tidak Boleh Kurang dari 4">
                                                            <div class="help-block with-errors"></div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-5 me-7 ">
                                                    <div class="input-group input-group-dynamic m-5">
                                                        <label class="text-bold">Surat Pengantar Nikah Yang Dari Lurah
                                                            :</label>
                                                        <div class="input-group input-group-dynamic mb-4">
                                                            <input class="form-control" aria-label="Berkas" type="file" name="spn" data-minlength="4" data-error="Tidak Boleh Kurang dari 4" accept=".pdf,.PDF,.doc,.docx,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document">
                                                            <div class="help-block with-errors"></div>
                                                        </div>
                                                        <em class="text-danger text-sm text-italic">*Upload berkas pendukung
                                                            (PDF, maksimal 2Mb)</em>
                                                        <input name="spn_lama" type="hidden" class="form-control input-sm" value="<?= $data['spn'] ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-5 me-7 ">
                                                    <div class="input-group input-group-dynamic m-5">
                                                        <label class="text-bold">Akte Perceraian *(Bagi Janda/Duda Cerai
                                                            ...
                                                            :</label>
                                                        <div class="input-group input-group-dynamic mb-4">
                                                            <input class="form-control" aria-label="Berkas" type="file" name="akte_c" data-minlength="4" data-error="Tidak Boleh Kurang dari 4" accept=".pdf,.PDF,.doc,.docx,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document">
                                                            <div class="help-block with-errors"></div>
                                                        </div>
                                                        <em class="text-danger text-sm text-italic">*Upload berkas pendukung
                                                            (PDF, maksimal 2Mb)</em>
                                                        <input name="akte_c_lama" type="hidden" class="form-control input-sm" value="<?= $data['akte_c'] ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-5 me-7 ">
                                                    <div class="input-group input-group-dynamic m-5">
                                                        <label class="text-bold">Surat Kematian *(Bagi Janda/Duda Cerai
                                                            Meninggal)</label>
                                                        <div class="input-group input-group-dynamic mb-4">
                                                            <input class="form-control" aria-label="Berkas" type="file" name="sk" data-minlength="4" data-error="Tidak Boleh Kurang dari 4" accept=".pdf,.PDF,.doc,.docx,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document">
                                                            <div class="help-block with-errors"></div>
                                                        </div>
                                                        <em class="text-danger text-sm text-italic">*Upload berkas pendukung
                                                            (PDF, maksimal 2Mb)</em>
                                                        <input name="sk_lama" type="hidden" class="form-control input-sm" value="<?= $data['sk'] ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-5 me-7 ">
                                                    <div class="input-group input-group-dynamic m-5">
                                                        ...
                                                        <div class="input-group input-group-dynamic mb-4">
                                                            <input class="form-control" aria-label="Berkas" type="file" name="skwn" data-minlength="4" data-error="Tidak Boleh Kurang dari 4" accept=".pdf,.PDF,.doc,.docx,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document">
                                                            <div class="help-block with-errors"></div>
                                                        </div>
                                                        <em class="text-danger text-sm text-italic">*Upload berkas pendukung
                                                            (PDF, maksimal 2Mb)</em>
...
WHERE id_spn = '$id'");
        ...
        if ($edit) {
            ...
            echo "<meta http-equiv='refresh' content='0; url=?page=dataSuratPengantarNikah'>";
        } else {
            echo "<script>alert('Data anda gagal diedit. Ulangi sekali lagi')</script>";
            echo "<meta http-equiv='refresh' content='0; url=?page=editSuratPengantarNikah'>";
        }
    }
}
