                                            ...
                                            <form data-toggle="validator" action="" method="POST" enctype="multipart/form-data">
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group input-group-dynamic">
                                                                <label>Surat Permohonan yang sudah ditanda tangani <br> Ketua RT atau Lurah : </label>
                                                                <div class="input-group input-group-dynamic mb-4">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group input-group-dynamic">
                                                                <label>Surat yang menyatakan bahwa pengurus dari institusi/Yayasan/Perusahaan atau badan hukum yang lainnya :</label>
                                                                <div class="input-group input-group-dynamic mb-4">
