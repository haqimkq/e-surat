...
if (!isset($_SESSION['nama'])) {
    ...
    // $id = $_SESSION['id_user'];
    // $query = mysqli_query($link, "SELECT * FROM tamu_masuk WHERE idTamuMasuk = '$id' ");
                ...
                <div class="card mb-4">
                    ...
                    <div class=" p-0 position-relative mt-n6 mx-4 z-index-4 ps-6">
                        <div class="bg-gradient-info shadow border-radius-lg pt-3 pb-3 ">
                            <h6 class="text-white text-capitalize ps-3">Data Tamu Masuk</h6>
                        </div>
                    </div>
                    <div class="card-body p-3 mt-3">
                        <!-- <div class="col-2 ">
                            <a href="?page=tambah_tamuMasuk" class="btn btn-info">Tambah Data</a>
                        </div> -->
                                ...
                                <table id="example" class="table align-items-center">
                                    <div class="table-responsive">
                                        ...
                                        <tbody>
                                            ...
                                            $query = mysqli_query($link, "SELECT * FROM tamu_masuk tm 
                                            join tamu t on t.idTamu  = tm.idTamu
                                            join keperluan k on k.idKeperluan  = tm.idKeperluan
                                             ");
                                            $i = 1;
                                                    ...
                                                    <td>
                                                        <div class=" mt-3">
                                                            ...
                                                            <ul class="dropdown-menu shadow-lg mt-2  dropdown-menu-end px-2 py-2 me-sm-n4" role="menu">
                                                                <li>
                                                                    <a class="dropdown-item border-radius-md" href="?page=edittamuMasuk&id=<?= $row[0]; ?>">
                                                                        <i class="fa fa-edit"></i>
                                                                        Edit Data</a>
                                                                </li>
                                                                <li>
                                                                    <a class="dropdown-item border-radius-md" onclick="return confirm ('Anda yakin ingin menghapus data ?');" href="?page=hapustamuMasuk&id=<?= $row[0]; ?>">
