...
if (!isset($_SESSION['nama'])) {
    ...
    $id = $_SESSION['id_user'];
    $query = mysqli_query($link, "SELECT * FROM jabatan WHERE id_jabatan = '$id' ");
            ...
            <div class="card mb-4">
                ...
                <div class=" p-0 position-relative mt-n6 mx-4 z-index-4 ps-6">
                    <div class="bg-gradient-info shadow border-radius-lg pt-3 pb-3 ">
                        <h6 class="text-white text-center text-capitalize ">Data Jabatan</h6>
                    </div>
                </div>
                                                ...
                                                <div class=" mt-3 ">
                                                    ...
                                                    <ul class="dropdown-menu shadow-lg mt-2  dropdown-menu-end px-2 py-2 me-sm-n4"
                                                        ...
                                                        <li><a class="dropdown-item border-radius-md"
                                                                href="?page=editjabatan&id=<?= $row[0]; ?>"><i
                                                                    class="fa fa-edit"></i> Edit Data</a></li>
                                                        <li><a class="dropdown-item border-radius-md"
                                                                onclick="return confirm ('Anda yakin ingin menghapus data ?');"
                                                                href="?page=hapusjabatan&id=<?= $row[0]; ?>"><i
        ...
        <div class="col-6">
            <div class="card mb-4">
                <div class=" justify-content-center mt-n3 mx-3 z-index-2 ps-1">
                    <div class="bg-gradient-info shadow border-radius-lg pt-3 pb-3 ">
                        <h6 class="text-white text-center text-capitalize ">Tambah Data Jabatan</h6>
                    </div>
                </div>
                <div class="card-body p-3 mt-3">
                    <section>
...
<?php
    if (isset($_POST['simpan'])) {
        ...
        $simpan = $link->query("INSERT INTO jabatan (nm_jabatan) VALUES ('$nm_jabatan')");
