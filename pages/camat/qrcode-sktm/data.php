                            ...
                            <table id="example" class="table align-items-center">
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                        <?php
                                            $no = 1;
                                            $query = mysqli_query($link, "SELECT * FROM qrcode qr 
                                            join pelayanan p on qr.id_pelayanan = p.id_pelayanan 
                                            join masyarakat m on qr.id_msy = m.id_msy 
                                            where j_pelayanan = 'Legalisasi SKTM' ");
                                            $i = 1;
                                                    ...
                                                    <ul class="dropdown-menu shadow-lg mt-2  dropdown-menu-end px-2 py-2 me-sm-n4"
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item border-radius-md"
                                                                ...
                                                                href="?page=hapus_qrSktm&id=<?= $row[0]; ?>">
