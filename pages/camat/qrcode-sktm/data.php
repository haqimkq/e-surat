                ...
                <div class="card mb-4">
                    ...
                    <div class=" p-0 position-relative mt-n6 mx-4 z-index-4 ps-6">
                        <div class="bg-gradient-info shadow border-radius-lg pt-3 pb-3 ">
                            <h6 class="text-white text-capitalize ps-3">QRCODE SURAT KETERANGAN TIDAK MAMPU</h6>
                        </div>
                    </div>
                    <div class="card-body p-3 mt-3">
                        <div class="col-2 ">
                            <a href="?page=tambah_qrSktm" class="btn btn-info">Tambah Data</a>
                        </div>
                                ...
                                <table id="example" class="table align-items-center">
                                    <div class="table-responsive">
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 1;
                                            $query = mysqli_query($link, "SELECT * FROM qrcode qr join pelayanan p on qr.id_pelayanan = p.id_pelayanan where j_pelayanan = 'Legalisasi SKTM' ");
                                            $i = 1;
                                            ...
                                            ?>
                                                <tr>
                                                    <td>
                                                        <div class=" mt-3">
                                                            ...
                                                            <a class="dropdown-item border-radius-md"
                                                                ...
                                                                <li>
                                                                    <a class="dropdown-item border-radius-md" onclick="return confirm ('Anda yakin ingin menghapus data ?');" href="?page=hapus_qrSktm&id=<?= $row[0]; ?>">
                                                    ...
                                                    <td align="center">
                                                        <?php
                                                        echo "<a class='badge bg-gradient-success' target='_blank' href='../qrcodeview/qrcode-sktm/qrcodeview.php?id={$row[0]}'><i class='fa fa-edit'></i> Print</a>";
                                                        ?>
                                                    </td>
                                                    <td>
                                                        <?php
                                                        echo "<a class='badge bg-gradient-success' target='_blank' href='../qrcodeview/qrcode-sktm/qrcode.php?id={$row[0]}'></i> generate qrcode</a>";
                                                        ?>
                                                    </td>
