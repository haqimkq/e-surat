                ...
                <div class="table-responsive">
                    <table id="example1" class="table table-bordered">
                        ...
                        <tbody>
                            <?php
                                $no = 1;
                                $data = $link->query("SELECT * FROM spn s 
...
<?php
    if (isset($_POST['simpan'])) {
        ...
        if ($simpan) {
            ...
            echo "<meta http-equiv='refresh' content='0; url=?page=qrCodeSpn'>";
        } else {
            echo "<script>alert('Data anda gagal disimpan. Ulangi sekali lagi')</script>";
            echo "<meta http-equiv='refresh' content='0; url=?page=tambah_qrSpn'>";
        }
    }
}
