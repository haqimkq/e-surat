            ...
            <div class="card mb-4">
                ...
                <div class=" p-0 position-relative mt-n6 mx-4 z-index-4 ps-6">
                    <div class="bg-gradient-info shadow border-radius-lg pt-3 pb-3 ">
                        <h6 class="text-white text-capitalize ps-3">QRCODE SURAT SUSUNAN KELUARGA</h6>
                    </div>
                </div>
                <div class="card-body p-3 mt-3">
                    <div class="col-2 ">
                        <a href="?page=tambah_qrSk" class="btn btn-info">Tambah Data</a>
                    </div>
                            ...
                            <table id="example" class="table align-items-center">
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                        <?php
                                            $no = 1;
                                            $query = mysqli_query($link, "SELECT * FROM qrcode qr join pelayanan p on qr.id_pelayanan = p.id_pelayanan join masyarakat m on qr.id_msy = m.id_msy where j_pelayanan = 'Legalisasi Susunan Keluarga' ");
                                            $i = 1;
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                        echo "<a class='badge bg-gradient-success' target='_blank' href='../qrcodeview/qrcode-sk/qrcode.php?id={$row[0]}'></i> generate qrcode</a>";
                                                        ?>
                                            </td>
