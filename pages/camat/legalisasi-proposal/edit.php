                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 text-center me-7 mt-4">
                                                <?php
                                                    if (!empty($data['ktp_p'])) {
...
WHERE id_lp = '$id'");
        ...
        if ($edit) {
            ...
            echo "<meta http-equiv='refresh' content='0; url=?page=dProposal'>";
        } else {
            echo "<script>alert('Data anda gagal diedit. Ulangi sekali lagi')</script>";
            echo "<meta http-equiv='refresh' content='0; url=?page=eProposal'>";
        }
    }
}
