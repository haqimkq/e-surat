                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-5 text-center me-7 mt-4">
                                                    ...
                                                    ?>
                                                    <div class="input-group input-group-dynamic justify-content-center mt-2 ">
                                                        <label class="text-bold">QrCode Verifikasi Camat</label>
                                                        <div class="input-group input-group-dynamic ">
                                                            <input class="form-control" aria-label="TTD Camat :" type="file" name="qrCode" data-minlength="4" data-error="Tidak Boleh Kurang dari 4" />
                                                            <div class="help-block with-errors"></div>
                                                        </div>
                                                    </div>
...
WHERE id_lp = '$id'");
        ...
        if ($edit) {
            ...
            echo "<meta http-equiv='refresh' content='0; url=?page=data_proposal'>";
        } else {
            echo "<script>alert('Data anda gagal diedit. Ulangi sekali lagi')</script>";
            echo "<meta http-equiv='refresh' content='0; url=?page=edit_proposal'>";
        }
    }
}
