    ...
    <div class="container-fluid py-4">
        <div class="row mt-4">
            <div class="col-12">
                <div class="card mb-4">
                    <div class="d-flex">
                        <div class="icon icon-shape icon-lg bg-gradient-warning shadow text-center border-radius-lg mt-n3 ms-3">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td class="w-3">
                                                        <div class="mt-3">
                                                            <button type="button" class="btn btn-warning dropdown-toggle border-radius-lg px-3 py-1 " id="dropdownMenuButton" data-bs-toggle="dropdown">
                                                                <i class="fa fa-bars"></i>
                                                            </button>
                                                            <ul class="dropdown-menu shadow-lg mt-2  dropdown-menu-end px-2 py-2 me-sm-n4" role="menu">
                                                                <li>
                                                                    <a class="dropdown-item border-radius-md" href="?page=editSuratDispensasiNikah&id=<?= $row[0]; ?>">
                                                                        <i class="fa fa-edit"></i>
                                                                        Edit Data</a>
                                                                </li>
                                                                <li>
                                                                    <a class="dropdown-item border-radius-md" onclick="return confirm ('Anda yakin ingin menghapus data ?');" href="?page=hapusSuratDispensasiNikah&id=<?= $row[0]; ?>">
                                                    ...
                                                    <td align="left">
                                                        <?php {
                                                            echo "<a class='badge bg-gradient-success' target='_blank' href='../pages/admin/surat-dispensasi-nikah/suratDispensasi.php?id={$row[0]}'><i class='fa fa-edit'></i> Print</a>";
                                                        }
                                                        ?>
                                                    </td>
                                                </tr>
