...
?>
                                            ...
                                            <form data-toggle="validator" action="" method="POST" enctype="multipart/form-data">
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <h6> <i>Legalisasi Surat Pengantar Nikah</i></h6>
                                                        <!-- <hr class="horizontal dark"> -->
                                                        <br>
                                                        <br>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group input-group-dynamic">
                                                                ...
                                                                <div class="input-group input-group-dynamic mb-4">
                                                                    <input class="form-control" aria-label="Foto" type="file" name="pas_foto" data-minlength="4" data-error="Tidak Boleh Kurang dari 4" required>
                                                                    <div class="help-block with-errors"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group input-group-dynamic">
                                                                <label>Surat Pengantar Nikah Yang Dari Lurah</label>
                                                                <div class="input-group input-group-dynamic mb-2">
                                                                    <input class="form-control" aria-label="" type="file" name="spn" data-minlength="4" data-error="Tidak Boleh Kurang dari 4" required>
                                                                    <div class="help-block with-errors"></div>
                                                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group input-group-dynamic">
                                                                <label>Akte Perceraian *(Bagi Janda/Duda Cerai Hidup)
                                                                </label>
                                                                <div class="input-group input-group-dynamic mb-2">
                                                                    <input class="form-control" aria-label="Foto" type="file" name="akte_c" data-minlength="4" data-error="Tidak Boleh Kurang dari 4" required>
                                                                    <div class="help-block with-errors"></div>
                                                                </div>
                                                                <em class="text-danger text-sm text-italic">*Upload
                                                                    berkas pendukung (PDF, maksimal 2Mb)</em>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group input-group-dynamic">
                                                                <label>Surat Kematian *(Bagi Janda/Duda Cerai
                                                                    Meninggal)</label>
                                                                <div class="input-group input-group-dynamic mb-2">
                                                                    <input class="form-control" aria-label="Foto " type="file" name="sk" data-minlength="4" data-error="Tidak Boleh Kurang dari 4" required>
                                                                    <div class="help-block with-errors"></div>
                                                                </div>
                                                                <em class="text-danger text-sm text-italic">*Upload
                                                                    berkas pendukung (PDF, maksimal 2Mb)</em>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group input-group-dynamic">
                                                                <label>Surat Keterangan Wali Nikah</label>
                                                                <div class="input-group input-group-dynamic mb-2">
                                                                    <input class="form-control" aria-label="Foto " type="file" name="skwn" data-minlength="4" data-error="Tidak Boleh Kurang dari 4" required>
                                                                    <div class="help-block with-errors"></div>
                                                                </div>
                                                                <em class="text-danger text-sm text-italic">*Upload
                                                                    berkas pendukung (PDF, maksimal 2Mb)</em>
    ...
    if (isset($_POST['simpan'])) {
        ...
        if ($simpan) {
            ...
            echo "<meta http-equiv='refresh' content='0; url=?page=tambahSuratPengantarNikah'>";
        }
    }
}
