                                    ...
                                    <div class="table-responsive">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class=" text-secondary text-s font-weight-bolder opacity-7">
                                                    Nilai Kinerja </th>
                                                <th class=" text-secondary w-5 text-center text-s font-weight-bolder opacity-7">
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 1;
                                            $query = mysqli_query($link, "SELECT * FROM skp k join pegawai p on k.id_pegawai = p.id_pegawai join jabatan j on k.id_jabatan = j.id_jabatan");
                                            $i = 1;
                                                    ...
                                                    <td class="w-5">
                                                        <div>
                                                            ...
                                                            <ul class="dropdown-menu shadow-lg mt-2  dropdown-menu-end px-2 py-2 me-sm-n4" role="menu">
                                                                <li>
                                                                    <a class="dropdown-item border-radius-md" href="?page=edit_KinerjaPegawai&id=<?= $row[0]; ?>">
                                                                        <i class="fa fa-edit"></i>
                                                                        Edit Data</a>
                                                                </li>
                                                                <li>
                                                                    <a class="dropdown-item border-radius-md" onclick="return confirm ('Anda yakin ingin menghapus data ?');" href="?page=hapus_KinerjaPegawai&id=<?= $row[0]; ?>">
