                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class=" text-secondary text-s font-weight-bolder opacity-7">
                                                Jabatan</th>
                                            <th class=" text-secondary text-s font-weight-bolder opacity-7">
                                                Tanggal Pemberian Kinerja </th>
                                            <th class=" text-secondary text-s font-weight-bolder opacity-7">
                                                Nilai Kinerja </th>
                                            <th class=" text-secondary text-s font-weight-bolder opacity-7">
                                                Keterangan Kinerja </th>
                                            <!-- <th class=" text-secondary text-s font-weight-bolder opacity-7">
                                                Detail Kinerja Pegawai</th> -->
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><?= $row['nilai_prestasi_kerja']; ?></td>
                                            <td align=" center">
                                                <?php
                                                ...
                                                <!-- <td align="center"><a target="_blank"
                                                    ...
                                                    class="btn btn-sm btn-primary" title="Cetak Surat"> Detail
                                                    Kinerja</a></td>
                                            </td> -->
                                                <?php
                                                }
