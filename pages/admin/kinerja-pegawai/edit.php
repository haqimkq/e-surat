                                            ...
                                            <div class="col-lg-12 mx-auto d-flex justify-content-center flex-column">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <input type="hidden" class="form-control" name="id_jabatan" id="id_jabatan" required value="<?= $data['id_jabatan'] ?>">
                                                        ...
                                                        <div class=" col-md-12">
                                                            <div class="input-group input-group-dynamic">
                                                                ...
                                                                <div class="input-group input-group-dynamic mb-4">
                                                                    <input class="form-control" aria-label="NIP" type="text" data-minlength="4" data-error="Tidak Boleh Kurang dari 4" required readonly value="<?= $data['nip'] ?>">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group input-group-dynamic">
                                                                ...
                                                                <div class="input-group input-group-dynamic ">
                                                                    <input class="form-control" aria-label="Nama Pegawai" type="text" name="nm_pegawai" data-minlength="4" data-error="Tidak Boleh Kurang dari 4" required readonly value="<?= $data['nm_pegawai'] ?>">
                                                                    <div class="help-block with-errors"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group input-group-dynamic">
                                                                <label>Jabatan</label>
                                                                <div class="input-group input-group-dynamic ">
                                                                    <input class="form-control" aria-label="Nama Pegawai" type="text" name="nm_jabatan" data-minlength="4" data-error="Tidak Boleh Kurang dari 4" required readonly value="<?= $data['nm_jabatan'] ?>">
                                                                    <div class="help-block with-errors"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                            ...
                            <div class="form-group  ">
                                ...
                                <div class="input-group input-group-outline my-3">
                                    ...
                                    <div class="col-12 col-md-3">
                                        <input step="0.01" type="number" name="nilai_skp" id="nilai_skp" class="form-control" role="nilai-rumus" data-label="#nilai_skp_label" value="<?= @$skp['nilai_skp'] ?>">
                                    </div>
                                    <div class="col-12 col-md-2">
                                        <input placeholder="Disabled" type="text" name="nilai_skp_label" id="nilai_skp_label" class="form-control" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-group input-group-outline my-3">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <input step="0.01" type="number" name="orientasi_pelayanan" id="orientasi_pelayanan" class="form-control" role="nilai-alpha" data-label="#orientasi_pelayanan_label" value="<?= @$skp['orientasi_pelayanan'] ?>">
                                        </div>
                                    ...
                                    <div class="input-group input-group-outline my-3">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <input step="0.01" type="number" name="komitmen" id="komitmen" class="form-control" role="nilai-alpha" data-label="#komitmen_label" value="<?= @$skp['komitmen'] ?>">
                                        </div>
                                        <div class="col-12 col-md-5">
                                    ...
                                    <div class="input-group input-group-outline my-3">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <input step="0.01" type="number" name="kerjasama" id="kerjasama" class="form-control" role="nilai-alpha" data-label="#kerjasama_label" value="<?= @$skp['kerjasama'] ?>">
                                        </div>
                                        <div class="col-12 col-md-5">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group input-group-outline my-3">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <input step="0.01" type="number" name="integritas" id="integritas" class="form-control" role="nilai-alpha" data-label="#integritas_label" value="<?= @$skp['integritas'] ?>">
                                        </div>
                                        <div class="col-12 col-md-5">
                                    ...
                                    <div class="input-group input-group-outline my-3">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <input step="0.01" type="number" name="disiplin" id="disiplin" class="form-control" role="nilai-alpha" data-label="#disiplin_label" value="<?= @$skp['disiplin'] ?>">
                                        </div>
                                        <div class="col-12 col-md-5">
                                ...
                                <div class="input-group input-group-outline my-3">
                                    ...
                                    <div class="col-12 col-md-3">
                                        <input placeholder="Disabled" step="0.01" type="number" name="nilai_prestasi_kerja" id="nilai_prestasi_kerja" class="form-control" value="<?= @$skp['nilai_prestasi_kerja'] ?>" data-label="#nilai_prestasi_kerja_label" readonly>
                                    </div>
                                    <div class="col-12 col-md-2">
                                ...
                                <div class="col-md-12">
                                    <div class="input-group input-group-dynamic">
                                        ...
                                        <div class="input-group input-group-dynamic mb-4">
                                            <input class="form-control" aria-label="Tanggal" type="date" name="tgl_kinerja" data-minlength="4" data-error="Tidak Boleh Kurang dari 4" required value="<?= $data['tgl_kinerja'] ?>">
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                </div>
...
WHERE idSkp = '$id'");
        ...
        if ($edit) {
            ...
            echo "<meta http-equiv='refresh' content='0; url=?page=edit_KinerjaPegawai'>";
        }
    }
}
