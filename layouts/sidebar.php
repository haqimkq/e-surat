                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-white ">
                                        <div class="text-white me-2 d-flex " type="button" class="btn bg-gradient-primary" data-bs-toggle="modal" data-bs-target="#exampleModal1">
                                            ...
                                            <span class="nav-link-text ms-3">Data Tamu</span>
                                        </div>
                                    </a>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Laporan Data Tamu</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <!-- <form method="POST" target="_blank" action="../laporan/l_tamu.php">
                                                ...
                                                <hr> -->
                                                    <div class="form-group text-center">
                                                        <a href="../laporan/l_tamu.php" target="_blank" class="btn btn-info btn-md">
                                                            <i class="fa fa-print"></i>
                                                            Cetak Semua</a>
                                                    </div>
                                                </div>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-white ">
                                        <div class="text-white me-2 d-flex " type="button" class="btn bg-gradient-primary" data-bs-toggle="modal" data-bs-target="#exampleModal2">
                                            <i class="material-icons opacity-10">turned_in_not</i>
                                            <span class="nav-link-text ms-3">Data Tamu Masuk</span>
                                        </div>
                                    </a>
                                    <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabe4" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Laporan Data Tamu Masuk</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <form method="POST" target="_blank" action="../laporan/l_tamumasuk.php">
                                                        <div class="form-group row">
                                                            <div class="col-md-4">
                                                                <label>Dari Tanggal</label>
                                                    ...
                                                    <hr>
                                                    <div class="form-group text-center">
                                                        <a href="../laporan/l_tamumasuk.php" target="_blank" class="btn btn-info btn-md">
                                                            <i class="fa fa-print"></i>
                                                            Cetak Semua</a>
                                                    </div>
                                                </div>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-white ">
                                        <div class="text-white me-2 d-flex " type="button" class="btn bg-gradient-primary" data-bs-toggle="modal" data-bs-target="#exampleModal3">
                                            <i class="material-icons opacity-10">turned_in_not</i>
                                            <span class="nav-link-text ms-3">Data Tamu Keluar</span>
                                        </div>
                                    </a>
                                    <div class="modal fade" id="exampleModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabe4" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Laporan Data Tamu Keluar</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <form method="POST" target="_blank" action="../laporan/l_tamukeluar.php">
                                                        <div class="form-group row">
                                                            <div class="col-md-4">
                                                                <label>Dari Tanggal</label>
                                                                <input type="date" class="form-control" name="tgl1" required>
                                                    ...
                                                    <hr>
                                                    <div class="form-group text-center">
                                                        <a href="../laporan/l_tamukeluar.php" target="_blank" class="btn btn-info btn-md">
                                                            <i class="fa fa-print"></i>
                                                            Cetak Semua</a>
                                                    </div>
                                                </div>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-white ">
                                        <div class="text-white me-2 d-flex " type="button" class="btn bg-gradient-primary" data-bs-toggle="modal" data-bs-target="#exampleModal4">
                                            <i class="material-icons opacity-10">turned_in_not</i>
                                            <span class="nav-link-text ms-3">Data surat Masuk</span>
                                        </div>
                                    </a>
                                    <div class="modal fade" id="exampleModal4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabe4" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Laporan Data surat Masuk</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <form method="POST" target="_blank" action="../laporan/l_suratmasuk.php">
                                                        <div class="form-group row">
                                                            <div class="col-md-4">
                                                                <label>Dari Tanggal</label>
                                                                <input type="date" class="form-control" name="tgl1" required>
                                                    ...
                                                    <hr>
                                                    <div class="form-group text-center">
                                                        <a href="../laporan/l_suratmasuk.php" target="_blank" class="btn btn-info btn-md">
                                                            <i class="fa fa-print"></i>
                                                            Cetak Semua</a>
                                                    </div>
                                                </div>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-white ">
                                        <div class="text-white me-2 d-flex " type="button" class="btn bg-gradient-primary" data-bs-toggle="modal" data-bs-target="#exampleModal5">
                                            <i class="material-icons opacity-10">turned_in_not</i>
                                            <span class="nav-link-text ms-3">Data Disposisi</span>
                                        </div>
                                    </a>
                                    <div class="modal fade" id="exampleModal5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabe4" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Laporan Data Disposisi</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <form method="POST" target="_blank" action="../laporan/l_disposisi.php">
                                                        <div class="form-group row">
                                                            <div class="col-md-4">
                                                                <label>Dari Tanggal</label>
                                                                <input type="date" class="form-control" name="tgl1" required>
                                                    ...
                                                    <hr>
                                                    <div class="form-group text-center">
                                                        <a href="../laporan/l_disposisi.php" target="_blank" class="btn btn-info btn-md">
                                                            <i class="fa fa-print"></i>
                                                            Cetak Semua</a>
                                                    </div>
                                                </div>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-white ">
                                        <div class="text-white me-2 d-flex " type="button" class="btn bg-gradient-primary" data-bs-toggle="modal" data-bs-target="#exampleModal6">
                                            <i class="material-icons opacity-10">turned_in_not</i>
                                            <span class="nav-link-text ms-3">Data surat Keluar</span>
                                        </div>
                                    </a>
                                    <div class="modal fade" id="exampleModal6" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabe4" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Laporan Data surat Keluar</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <form method="POST" target="_blank" action="../laporan/l_suratkeluar.php">
                                                        <div class="form-group row">
                                                            <div class="col-md-4">
                                                                <label>Dari Tanggal</label>
                                                                <input type="date" class="form-control" name="tgl1" required>
                                                    ...
                                                    <hr>
                                                    <div class="form-group text-center">
                                                        <a href="../laporan/l_suratkeluar.php" target="_blank" class="btn btn-info btn-md">
                                                            <i class="fa fa-print"></i>
                                                            Cetak Semua</a>
                                                    </div>
                                                </div>
                ...
                <ul class="navbar-nav">
                        ...
                        <div class="collapse" id="data-master">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                <li>
                                    ...
                                    <a class="nav-link text-white " href="?page=datajabatan">
                                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                                            <i class="material-icons opacity-10">library_books</i>
                                        </div>
                                    ...
                                    <a class="nav-link text-white " href="?page=datakeperluan">
                                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                                            <i class="material-icons opacity-10">assignment_ind</i>
                                        </div>
                                        <span class="nav-link-text ms-1">Jenis Keperluan</span>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="data-keperluan">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                <li>
                                    <a class="nav-link text-white " href="?page=datatamuMasuk">
                                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                                            <i class="material-icons opacity-10">rotate_right</i>
                                        </div>
                                        <span class="nav-link-text ms-1">Tamu Masuk</span>
                                    </a>
                                    <a class="nav-link text-white " href="?page=datatamuKeluar">
                                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                                            <i class="material-icons opacity-10">rotate_left</i>
                                        </div>
                                        <span class="nav-link-text ms-1">Tamu Keluar</span>
