                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <hr>
                                                    <div class="form-group text-center">
                                                        <a href="../laporan/l_sk.php" target="_blank" class="btn btn-info btn-md"><i class="fa fa-print"> </i>
                                                            Cetak
                                                            Semua</a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="modal-body">
                                                    <form method="POST" target="_blank" action="../laporan/l_news.php">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-4" style="margin-top: 31px;">
                                                                <button align="center" type="submit" name="cetak6" class="btn btn-info btn-md"><i class="fa fa-print">
                                                                    </i>
                                                                    Cetak</button>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <hr>
                                                    <div class="form-group text-center">
                                                        <a href="../laporan/l_news.php" target="_blank" class="btn btn-info btn-md"><i class="fa fa-print"> </i>
                                                            Cetak
                                                            Semua</a>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="modal fade" id="exampleModal7" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabe4" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group text-center">
                                                        <a href="../laporan/l_msy.php" target="_blank" class="btn btn-info btn-md"><i class="fa fa-print"> </i>
                                                            Cetak
                                                            Semua</a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="modal-body">
                                                    <form method="POST" target="_blank" action="../laporan/l_KinerjaKec.php">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-4" style="margin-top: 31px;">
                                                                <button align="center" type="submit" name="cetak8" class="btn btn-info btn-md"><i class="fa fa-print">
                                                                    </i>
                                                                    Cetak</button>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <hr>
                                                    <div class="form-group text-center">
                                                        <a href="../laporan/l_KinerjaKec.php" target="_blank" class="btn btn-info btn-md"><i class="fa fa-print"> </i>
                                                            Cetak
                                                            Semua</a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="modal-body">
                                                    <form method="POST" target="_blank" action="../laporan/l_KinerjaPegawai.php">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-4" style="margin-top: 31px;">
                                                                <button align="center" type="submit" name="cetak9" class="btn btn-info btn-md"><i class="fa fa-print">
                                                                    </i>
                                                                    Cetak</button>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <hr>
                                                    <div class="form-group text-center">
                                                        <a href="../laporan/l_KinerjaPegawai.php" target="_blank" class="btn btn-info btn-md"><i class="fa fa-print"> </i>
                                                            Cetak
                                                            Semua</a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="modal-body">
                                                    <form method="POST" target="_blank" action="../laporan/l_PerjalananDinas.php">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-4" style="margin-top: 31px;">
                                                                <button align="center" type="submit" name="cetak10" class="btn btn-info btn-md"><i class="fa fa-print">
                                                                    </i>
                                                                    Cetak</button>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <hr>
                                                    <div class="form-group text-center">
                                                        <a href="../laporan/l_PerjalananDinas.php" target="_blank" class="btn btn-info btn-md"><i class="fa fa-print"> </i>
                                                            Cetak
                                                            Semua</a>
                                                    </div>
                                                </div>
