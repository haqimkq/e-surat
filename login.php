                ...
                <div class="row">
                    <div class="col-lg-4 col-md-8 col-12 mx-auto">
                        <div class="cardd z-index-0 fadeIn3 fadeInBottom">
                            ...
                            <div class="card-body">
                                <h6 class="text-white font-weight-bolder text-center mt-2 mb-0">LOGIN</h6>
                                <form action="db/cek_login.php" method="post">
                                    ...
                                    <p class="text-white mt-4 text-sm text-center">
                                        ...
                                        <a href="../aev/public/signup-pegawai.php"
                                            class="text-warning text-gradient font-weight-bold">Daftar Pegawai</a>
                                    </p>
                                    <p class="text-white mt-4 text-sm text-center">
