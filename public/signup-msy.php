...
<head>
    ...
    <!-- Nucleo Icons -->
    <link href="../e-surat/assets/css/nucleo-icons.css" rel="stylesheet" />
    <link href="../e-surat/assetss/css/nucleo-svg.css" rel="stylesheet" />
    <!-- Font Awesome Icons -->
                        ...
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5">
                            <div class="card card-plain">
                                ...
                                <div class="card-header">
                                    <h4 class="font-weight-bolder">Daftar Akun Masyarakat</h4>
                                ...
                                <div class="card-body">
                                    <form action="" method="post">
                                        ...
                                        <input type="hidden" name="level" class="form-control" value="2" required />
