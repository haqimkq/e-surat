            ...
            <div class="card ">
                <div class="card-header p-3 pt-2">
                    ...
                    <div class="text-end pt-1">
                        ...
                        <h4 class="mb-0"> <a href="?page=dSusunanKeluarga"><?php echo $hitungsk['total'] ?></a>
                        </h4>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-header p-3 pt-2">
                    ...
                    <div class="text-end pt-1">
                        ...
                        <h4 class="mb-0"><a href="?page=dPengantarNikah"><?php echo $hitungspn['total']; ?></a>
                        </h4>
                    </div>
                </div>
                <hr class="dark horizontal my-0">
            ...
            <div class="card">
                <div class="card-header p-3 pt-2 ">
                    ...
                    <div class="text-end pt-1">
                        ...
                        <h4 class="mb-0"><a href="?page=dSktm"><?php echo $hitungsktm['total'] ?></a></h4>
                    </div>
                </div>
                <hr class="dark horizontal my-0">
                <div class="card-footer p-3">
            ...
            <div class="card">
                <div class="card-header p-3 pt-2">
                    ...
                    <div class="text-end pt-1">
                        ...
                        <h4 class="mb-0"><a href="?page=dDispensasiNikah"><?php echo $hitungrdn['total']; ?></a>
                        </h4>
                    </div>
                </div>
                <hr class="dark horizontal my-0">
            ...
            <div class="card">
                <div class="card-header p-3 pt-2">
                    ...
                    <div class="text-end pt-1">
                        ...
                        <h4 class="mb-0"><a href="?page=dProposal"><?php echo $hitunglp['total']; ?></a></h4>
                    </div>
                </div>
                <hr class="dark horizontal my-0">
                <div class="card-footer p-3">
